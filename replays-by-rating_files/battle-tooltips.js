...
move=new Move(move.id,"",Object.assign(Object.assign({},
move),{},{
name:'Z-'+move.name}));
...
move=new Move(zMove.id,zMove.name,Object.assign(Object.assign({},
zMove),{},{
...
move=new Move(maxMove.id,maxMove.name,Object.assign(Object.assign({},
maxMove),{},{
category:move.category,
...
if(side.battle.speciesClause)return false;for(var _i8=0,_side$pokemon2=
side.pokemon;_i8<_side$pokemon2.length;_i8++){var ally=_side$pokemon2[_i8];
...
var pokemon=clientPokemon||serverPokemon;
var isPowerTrick=clientPokemon==null?void 0:clientPokemon.volatiles['powertrick'];for(var _i9=0,_Dex$statNamesExceptH=
Dex.statNamesExceptHP;_i9<_Dex$statNamesExceptH.length;_i9++){var statName=_Dex$statNamesExceptH[_i9];
...
if(this.battle.gen<=1){for(var _i10=0,_Dex$statNamesExceptH2=
Dex.statNamesExceptHP;_i10<_Dex$statNamesExceptH2.length;_i10++){var _statName=_Dex$statNamesExceptH2[_i10];
...
outer:for(var _i11=0,_this$battle$sides2=this.battle.sides;_i11<_this$battle$sides2.length;_i11++){var side=_this$battle$sides2[_i11];for(var _i12=0,_side$active2=
...
if(allyActive){for(var _i13=0;_i13<
allyActive.length;_i13++){var ally=allyActive[_i13];
...
if(!short){
var hasModifiedStat=false;for(var _i15=0,_Dex$statNamesExceptH3=
Dex.statNamesExceptHP;_i15<_Dex$statNamesExceptH3.length;_i15++){var statName=_Dex$statNamesExceptH3[_i15];
...
buf+='<p>';
}for(var _i16=0,_Dex$statNamesExceptH4=

Dex.statNamesExceptHP;_i16<_Dex$statNamesExceptH4.length;_i16++){var _statName2=_Dex$statNamesExceptH4[_i16];
...
ppUsed=function ppUsed(move,pokemon){for(var _i17=0,_pokemon$moveTrack=
pokemon.moveTrack;_i17<_pokemon$moveTrack.length;_i17++){var _ref2=_pokemon$moveTrack[_i17];var moveName=_ref2[0];var ppUsed=_ref2[1];
...
value.abilityModify(1.3,"Compound Eyes");for(var _i18=0,_pokemon$side$active=
pokemon.side.active;_i18<_pokemon$side$active.length;_i18++){var active=_pokemon$side$active[_i18];
...
var boostCount=0;for(var _i19=0,_Object$values=
Object.values(target.boosts);_i19<_Object$values.length;_i19++){var boost=_Object$values[_i19];
...
var _boostCount=0;for(var _i20=0,_Object$values2=
Object.values(pokemon.boosts);_i20<_Object$values2.length;_i20++){var _boost=_Object$values2[_i20];
...
if(move.category!=='Status'){
var auraBoosted='';
var auraBroken=false;for(var _i21=0,_pokemon$side$active2=
pokemon.side.active;_i21<_pokemon$side$active2.length;_i21++){var ally=_pokemon$side$active2[_i21];
if(!ally||ally.fainted)continue;
var allyAbility=this.getAllyAbility(ally);
...
}for(var _i22=0,_pokemon$side$foe$act=
pokemon.side.foe.active;_i22<_pokemon$side$foe$act.length;_i22++){var foe=_pokemon$side$foe$act[_i22];
...
if(!types)types=this.getPokemonTypes(pokemon);for(var _i23=0,_types=
types;_i23<_types.length;_i23++){var curType=_types[_i23];
