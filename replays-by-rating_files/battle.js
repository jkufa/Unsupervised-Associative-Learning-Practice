...
_poke28.addVolatile('formechange',speciesForme);for(var _i20=0,_tpoke$moveTrack=
...
var searchid=serverPokemon.ident+"|"+serverPokemon.details;for(var _i25=0,_this$sides$siden$pok=
this.sides[siden].pokemon;_i25<_this$sides$siden$pok.length;_i25++){var _pokemon4=_this$sides$siden$pok[_i25];
...
if(!isInactive&&side.active[slot])return side.active[slot];for(var _i26=0,_side$pokemon=

side.pokemon;_i26<_side$pokemon.length;_i26++){var _pokemon5=_side$pokemon[_i26];
