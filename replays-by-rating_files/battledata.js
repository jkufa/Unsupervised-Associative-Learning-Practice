...
species=new Species(formid,name,Object.assign(Object.assign({},
species),{},{
name:forme,
...
data.baseStats=Object.assign(Object.assign({},data.baseStats),table.overrideStats[id]);
}
...
data=Object.assign(Object.assign({},data),window.BattleTeambuilderTable['gen'+i].overrideTypeChart[id]);
}
}
